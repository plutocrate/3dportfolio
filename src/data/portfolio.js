...
export const BLOG_POSTS = [
{
  ...
  "'I choose pain.'",
  "Hear me out.",
  "Past 6 years, I degraded myself.",
  "I searched for love, pleasure, meaning and wisdom in the most esoteric way possible.",
  "I found nothing.",
  "No meaning.",
  "I don't belong to this world anymore.",
  "Not because I'm special.",
  "Because things people sincerely care about don't move me anymore.",
  "Money.",
  "Market image.",
  "Insecurities.",
  "Ownership.",
  "Emotional breakdowns.",
  "I don't know man. I'm no wordsmith.",
  "This blog comes after quite some time.",
  "I realised I got addicted to healing.",
  "Healing became another distraction.",
  "I don't heal.",
  "I just survive.",
  "My mind developed muscle memory.",
  "A familiar situation appears.",
  "The same thoughts arrive.",
  "The same behaviour follows.",
  "Again.",
  "Again.",
  "Again.",
  "Six years now.",
  ...
  "I want to starve.",
  "Stay quiet.",
  "Get rid of my obsession with absurdism.",
  "Get rid of lust.",
  "Get rid of my obesity.",
  "Get rid of my careless behaviour.",
  "Get rid of my obsession with exploring life.",
  "Maybe I explored enough.",
  "After all we all die, right?",
  "Fuck your 'after all we all die.'",
  "I don't want debates.",
  "Arguments.",
  "Conversations.",
  "My only interaction with humanity will be my job.",
  "Besides that, I'll disappear.",
  "Even though my world doesn't care whether I disappear or not.",
  "Let's end the pain of mental agony.",
  "And begin the pain of growth.",
  "Sounds very fake motivation guru.",
  "Probably my cringiest blog.",
  "But I'm tired of introspecting.",
  "I've studied myself long enough.",
  "Maybe wisdom comes from introducing new variables into life while staying aware.",
