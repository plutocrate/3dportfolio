...
{
  id: "22th-blog",
  title: "Crazy ass engineer.",
  subtitle: "",
  date: "1426, 17 Aug 2026",
  categories: ["growth plan"],
  body: [
	"I don't want to learn frameworks. I want to understand what the fuck is happening underneath them. I want to know what happens when I type a URL, where the bytes go, how a server receives them, how a browser turns them into a page, how a database stores them, and how pixels eventually appear on my screen.",

"Every fucking day — DSA",

"☐ 45–60 minutes of DSA. Every day. No excuses.",
...
"☐ Implement some of them in C. I don't want to just solve problems. I want to understand the fucking data structure.",

"Read: CS50x — C, memory & data structures",

"Read: C reference — cppreference",

"Week 1 — The machine",

"☐ C basics, pointers, memory, stack vs heap, structs, malloc/free, files, compilation and linking.",

"☐ Understand processes and basic system calls.",

"☐ Build cat — read and print a file.",

"☐ Build wc — count lines, words and bytes.",

"☐ Build a dynamic array.",

"☐ Build a hash table.",

"☐ Build a tiny memory arena.",

"☐ Understand Git properly: working tree, staging, commits, branches and remotes.",

"Read: C language reference",

"Read: GNU C Library documentation",

"Read: Linux man-pages",

"Read: Pro Git",

"Week 2 — Processes & networking",
...
"☐ Build a TCP client in C.",

"☐ Build a two-person terminal chat.",

"☐ Build a tiny file-transfer experiment.",

"Read: Linux socket documentation",
...
"☐ Return status codes, headers and bodies.",
...
"☐ No Express. No Next. Just me and HTTP.",

"Read: MDN — HTTP Overview",

"Read: RFC 9110 — HTTP Semantics",

"Read: Node.js HTTP documentation",
...
"☐ Build a tiny task queue.",

"☐ Try implementing a tiny Promise.",

"Read: TypeScript Handbook",

"Read: TypeScript Everyday Types",

"Read: TypeScript Modules",

"Read: MDN JavaScript Guide",
...
"☐ Build a streaming file reader.",

"☐ Build a TCP chat server.",

"☐ Rebuild my Week 3 HTTP server in Node.",

"Read: Node.js Learn",

"Read: Node.js HTTP API",

"Read: Node.js Event Loop guide",
...
"☐ Design my own schema.",

"☐ Write raw SQL.",

"☐ Connect Node to PostgreSQL.",

"☐ Build a small database layer.",

"☐ No ORM until I understand the SQL underneath it.",

"Read: PostgreSQL Tutorial",
...
"☐ Manipulate the DOM without React.",

"☐ Build a tiny reactive state system.",

"☐ Build a tiny component system.",

"☐ Build a tiny router.",

"☐ Fetch data from my own server.",

"☐ Render that data in the browser.",

"Read: MDN — How the Web Works",

"Read: MDN — How browsers load websites",

"Read: MDN — How browsers work",

"Read: MDN — DOM scripting",

"Read: MDN — Fetch API",

"Read: MDN — Critical rendering path",

"I am allowed to use React now because I understand what React is hiding.",
...
"☐ Build a collaborative canvas.",

"☐ Draw on one browser and see it appear on another.",

"☐ Understand what the fuck happens when two people modify the same state.",

"Read: MDN — WebSocket API",

"Week 10 — Linux & self-hosting",
...
"☐ Learn Docker only after understanding what the fuck I am containerizing.",

"Read: systemd documentation",

"Read: Docker documentation",

"Read: Caddy documentation",

"Week 11 — Mathematics & graphics",
...
"☐ Build sine-wave movement.",

"☐ Build a particle system.",

"☐ Build a camera.",

"☐ Build a tiny 2D renderer.",
...
"☐ Understand vertex → shader → rasterization → pixel.",

"Read: LearnOpenGL",

"Read: MDN — Web performance & animation",

"Week 12 — Stop learning",
...
"☐ Maybe the collaborative canvas.",

"☐ Maybe a tiny game.",

"☐ Maybe a tiny game engine.",

"☐ Maybe something I haven't even thought of yet.",

"The rules are simple. Read documentation before watching someone explain it. Build before copying. If I watch something, close it and rebuild it myself. If I don't understand something, build a smaller version. Commit the code. Write down what I learned.",

"I am not allowed to add another technology to this list because I suddenly saw a cool fucking video.",
...
"Another framework can wait.",

"Another business idea can wait.",

"I have enough fucking things to learn.",

"I don't want to become employable by memorizing frameworks. I want to understand computers well enough that when I see something crazy, my first thought is: I wonder how that works.",

"This isn't another grand five-year plan. This is twelve weeks of fucking practice.",

"I've spent enough time imagining the person I could become.",

"Now I want to become him the boring way.",

"Read. Build. Break. Debug. Sleep. Wake up. Do it again."
  ],
  media: ["/media/career.jpg"],
  link: "",
},
{
  id: "20th-blog",
