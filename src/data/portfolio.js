...
export const BLOG_POSTS = [
{
  ...
  body: [
    "I remained a non believer for quite some time now, maybe around 2 years, and I wanted to write about the before and after.",
    "Before all this, I had good relations with people around me. I still believe intellect has nothing to do with belief systems. I met people building startups, people obsessed with money, people trying to make something out of themselves. I resonated with them too. My definition of life was simple, self revenge. I must grow, become wealthy, stable, luxurious, and take revenge against myself for all those years I wasted suffering and wandering. Infact I worked hard. Real hard.",
    "I pulled good girls. Made good friends. My nature has always been to explore. Life has this weird habit of unfolding it's secrets in front of me, even when I'm not interested in learning them.",
    "Now, I'm a non believer.",
    "Non believer of God? No.",
    "A non believer of almost everything.",
    "I question the model of society itself. I question authority. Not because I want to rebel, but because my mind refuses to accept things without denying them first. It's almost a reflex now.",
    "Something changed though.",
    "I'm no longer that ambitious hard worker I used to be. I still want to build, probably more than ever, but I've completely lost my sense of urgency. I don't hurry anymore. I don't feel that guilt of missing out. I just like to exist.",
    "Which is also fake. I haven't mastered myself. I still see a beautiful girl and fall for her. What is it now... around the 30th girl in the last 4-5 years? And the funny part is, I never hide it. Either my behaviour gives it away or I just confess.",
    "Now, I'm lonely. Yeah I know there are people around me, and I can still interact with them, but my selectivity has become painfully small.",
    "I don't fit into where I want to fit anymore. I want conversations about people, art, games, cinema, stories and weird observations. Instead I mostly end up talking about things that don't move me.",
    "And yeah, I still want good booties, good folks, and good sex. I'm still painfully human after all.",
    "Maybe that's the irony. I stopped believing in almost everything, except the things that make me feel alive.",
    "Maybe that's why it feels like there's no place for non believers."
  ],
...
},
  {
    ...
    "I found nothing.",
    "No meaning.",
    "Healing became another distraction.",
    "I don't heal.",
    "I just survive.",
    "Again.",
    "Again.",
    "Again.",
    "Six years now.",
    "This time I'll deliberately go insane.",
    "I want to starve.",
    "Stay quiet.",
    "Get rid of lust.",
    "Get rid of my obesity.",
    "Get rid of my careless behaviour.",
    "Maybe I explored enough.",
    "Let's end the pain of mental agony.",
    "And begin the pain of growth.",
    "Sounds like fake motivation.",
    "Probably my cringiest blog.",
    "I'm done introspecting.",
    "Maybe it's finally time to build something."
  ],
