  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        <div className="font-mono text-[clamp(11px,calc(10.4px+0.2vw),13px)] uppercase tracking-[0.25em] text-white/58">Now</div>
        {NOW.updated && (
      ...
      <div className="space-y-3">
        {rows.map((row) => (
          <div key={row.key} className="flex gap-4">
            <span className="font-mono text-[clamp(9px,calc(8.44px+0.14vw),11px)] uppercase tracking-[0.18em] text-white/58 w-16 sm:w-20 shrink-0 pt-0.5">
              {row.label}
            </span>
