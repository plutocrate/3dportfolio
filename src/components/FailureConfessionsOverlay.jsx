  ...
  return (
    <div className="py-6">
      <div className="flex items-center gap-2 mb-2.5">
        ...
        {confession.date && (
          <span className="font-mono text-[clamp(9px,calc(8.44px+0.14vw),11px)] text-white/25 tabular-nums">
            · {confession.date}
          </span>
        )}
      </div>
      <p className="font-body text-[clamp(14px,calc(13px+0.5vw),17px)] text-white/70 leading-relaxed max-w-[640px]">
        {confession.text}
      </p>
    </div>
  )
    ...
    >
      ...
      >
        ...
        <div className="px-5 sm:px-12 pt-14 sm:pt-16 pb-12 sm:pb-16">
          ...
          <p className="font-body text-[clamp(13px,calc(12.4px+0.24vw),15px)] text-white/45 leading-relaxed max-w-[560px] mb-2">
          ...
          {FAILURE_CONFESSIONS.length === 0 ? (
            <div className="flex flex-col gap-2 py-4">
              ...
              <p className="font-body text-[clamp(12px,calc(11.08px+0.28vw),15px)] text-white/30">
                Add entries to <span className="font-mono text-white/40">FAILURE_CONFESSIONS</span> in{' '}
                <span className="font-mono text-white/40">src/data/failureConfessions.js</span>
              </p>
            </div>
          ) : (
